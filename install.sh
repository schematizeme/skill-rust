#!/usr/bin/env bash
# install.sh — instala a skill schematize-rust no projeto atual (Claude Code).
#
...
# Como funciona: copia o corpo da skill para .claude/skills/schematize-rust/ e instala os
...
# Saída: .claude/skills/schematize-rust/ e .claude/commands/<slug>-*.md no alvo.
set -euo pipefail

SKILL_NAME="schematize-rust"
