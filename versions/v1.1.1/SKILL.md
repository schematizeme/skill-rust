...
**Versão:** skill `schematize-rust` v1.0.0. Changelog em `CHANGELOG.md`.
...
- **Pisos de código (`references/padroes-codigo.md`):** arquivos **≤ 300 linhas**, **uma função/unidade lógica por arquivo** (função > 300 linhas é quebrada), **toda função com doc-comment** (`///`: motivo, comportamento esperado, entradas, saídas, efeitos), **`MAPA.md` da aplicação** atualizado no mesmo PR e **índice de microfunções** regenerado (`/rust-index`).
