...
> **Dividida:** §22.4–§23 (padrão de script, seeds, CI, pentest §22.7–22.8, Makefile) estão em `references/testes-execucao.md`. Numeração contínua entre os dois. O Q.A. plan-first vive na skill dedicada **schematize-qa** (`/qa-plan` → `/qa-run`).
