...
- `INDEX_GLOBAL.md`: **cada** repo/serviço com 1 linha, árvore de pastas top-level e o **grafo de serviços**. Nenhum de fora.
- Espelhe no `MAPA.md` da raiz (§4): microfunções geradas + grafos (§2.5, §5).
