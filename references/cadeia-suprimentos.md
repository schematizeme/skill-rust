# cadeia suprimentos — recorte Rust

> **PONTEIRO, não cópia.** A normativa deste tema é da base: **`schematize-engineering`** →
> `references/cadeia-suprimentos.md`. Leia lá primeiro; aqui fica **só o que muda em Rust**.
>
...
_Nada nesta área muda em Rust: o piso da base vale integralmente._
